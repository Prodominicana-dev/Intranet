      ...
      >
        ...
        >
          <form className="w-full flex flex-col gap-5" action={handleSubmit}>
            ...
            {warning && question === "" && (
              <label htmlFor="question" className="text-red-600 font-xs">
            ...
            <label className="text-xs text-center text-black">
              En caso de cambiarle el tipo de una pregunta de selección múltiple
              se eliminarán todas las opciones, así que ten mucho cuidado con
