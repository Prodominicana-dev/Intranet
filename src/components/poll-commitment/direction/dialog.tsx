...
import { createDirection } from "@/service/rrhh/poll-commitment/direction/service";

export function PollDirectionDialog({
  open,
  handler,
  update,
}: {
  ...
  const handleSubmit = async () => {
    ...
    await createDirection(data, handler, update);
    setIsLoading(false);
  };
