...
import {
  editcarriers,
} from "@/service/rrhh/jobs/vacancy/carriers/service";

export function EditVacancyCarriersDialog({
  carriers,
  open,
  handler,
  update,
  ...
  const handleSubmit = async () => {
    ...
    await editcarriers(carriers.id, data, handler, update);
    setIsLoading(false);
  };
