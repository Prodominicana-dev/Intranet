...
import Card from "@/components/poll-commitment/category/card";
import { PollCategoryDialog } from "@/components/poll-commitment/category/dialog";
...
export default function Page() {
  ...
  return (
    <>
      <Sketch
        title=" Categoría de la Encuesta"
        subtitle="RRHH"
        ...
        <div className="w-full flex flex-col gap-5">
          <div className="w-full flex justify-between">
            ...
            <div className="text-black flex items-center space-x-2">
              ...
              />
              <span>Categoría por página.</span>
            </div>
          </div>
